...
int main(){
    ...
    if( !(fp = fopen(fileName,"r")) ){
        printf("\n\nCould not open file %s.\nPlease check if the name is correct and if it is inside the directory you are using!\n\n",fileName);
        return 1;
    }
    ...
    printf("\nThe average weight of the %d northern elephant seals observed is %.2lf.\n\n",i,average);
